with Ada.Text_IO, Ada.Integer_Text_IO, Ada.Directories, display, stats, player, game_map, inventory_list, save_load_game;
use Ada.Text_IO, Ada.Integer_Text_IO, Ada.Directories, display, stats, player, game_map, inventory_list, save_load_game;
